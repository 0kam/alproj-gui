...
uv run pyinstaller \
    ...
    --hidden-import "alproj" \
    --collect-submodules "alproj" \
    ...
    --hidden-import "kornia_moons" \
    --hidden-import "kornia_rs" \
    --hidden-import "huggingface_hub" \
    --hidden-import "loguru" \
    --hidden-import "safetensors" \
    --hidden-import "safetensors.torch" \
    --hidden-import "einops" \
    --hidden-import "poselib" \
    --hidden-import "yacs" \
    ...
    --hidden-import "h5py" \
    --hidden-import "e2cnn" \
    --hidden-import "transforms3d" \
    --hidden-import "flow_vis" \
    --hidden-import "lightning" \
    --hidden-import "pytorch_lightning" \
    --hidden-import "timm" \
    --hidden-import "roma" \
    --hidden-import "sklearn" \
    --hidden-import "uniception" \
